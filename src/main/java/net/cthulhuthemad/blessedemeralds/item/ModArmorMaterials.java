...
public enum ModArmorMaterials implements ArmorMaterial {
    EMERALD("emerald", 30, new int[]{3, 6, 8, 3}, 12,
            SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.5F, 0.0F, () ->
            Ingredient.ofItems(Items.EMERALD)),
    BLESSED_EMERALD("blessed_emerald", 50, new int[]{8, 11, 13, 8}, 30,
            SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 6.0F, 0.2F, () ->
