...
public class ModFoodComponents {
    public static FoodComponent BLESSED_APPLE = new FoodComponent.Builder().hunger(4).saturationModifier(1.2F)
            ...
            .statusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 6000, 4), 1.0f)
            .statusEffect(new StatusEffectInstance(StatusEffects.HEALTH_BOOST, 6000, 4), 1.0f)
            .statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 6000, 4), 1.0f)
